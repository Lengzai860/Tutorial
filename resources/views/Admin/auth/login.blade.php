            ...
            <div class="block xl:grid grid-cols-2 gap-4">
                ...
                <div class="hidden xl:flex flex-col min-h-screen">
                    <a href="login-light-login.html" class="-intro-x flex items-center pt-5">
                        ...
                        <span class="text-black text-lg ml-3"> Ru<span class="font-medium">bick</span> </span>
                    </a>
                    <div class="my-auto">
                ...
                <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                    <div class="my-auto mx-auto xl:ml-20 bg-white dark:bg-dark-1 xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                        ...
                        @csrf
                            <input type="email" name="email" class="intro-x login__input form-control py-3 px-4 border-gray-300 block" value="{{ old('email') }}" placeholder="Email">
                            @error('email')
                        ...
                        <div class="intro-x flex text-gray-700 dark:text-gray-600 text-xs sm:text-sm mt-4">
                            <div class="flex items-center mr-auto">
                                ...
                                <label class="cursor-pointer select-none" for="remember-me" {{ old('remember') ? 'checked' : '' }}>Remember me</label>
                            </div>
                        ...
                        <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                            ...
                            <a href="{{route('admin.register')}}" class="btn btn-outline-secondary py-3 px-4 w-full xl:w-32 mt-3 xl:mt-0 align-top">Sign up</a></button>
                        </div>
                        </form>
                        <div class="intro-x mt-10 xl:mt-24 text-gray-700 dark:text-gray-600 text-center xl:text-left">
                            By signin up, you agree to our 
                            <br>
                            <a class="text-theme-1 dark:text-theme-10">Terms and Conditions</a> & <a class="text-theme-1 dark:text-theme-10">Privacy Policy</a> 
                        </div>
